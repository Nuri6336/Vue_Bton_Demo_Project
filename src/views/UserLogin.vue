<template>
  <div class="cont" :class="{ 's--signup': isSignUpActive }">
    <div class="form sign-in">
      <h2>
        <img src="../assets/logo1-removebg-preview.png" alt="" width="180px" />
      </h2>
      <label>
        <span>Email</span>
      ...
      <button type="button" class="submit" @click="handleSignIn">
        Sign In
      </button>
    </div>
...
export default {
  ...
  methods: {
    handleSignIn() {
      console.log("Signing in with:", this.signInEmail, this.signInPassword);
    },
    handleSignUp() {
      console.log(
        "Signing up with:",
